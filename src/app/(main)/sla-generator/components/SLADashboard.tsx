        ...
        <>
            ...
            <div className="mt-6">
                {activeTab === "active" ? (
                    <DataTable
                        data={displayData}
                        columns={activeSLAColumns(handleEdit, (id) => setSlaToArchive(id), handleView)}
                        showExport={false}
                        showViewOptions={false}
                        showFilterbar={true}
                        onCreate={() => router.push("/sla-generator?mode=create")}
                    ...
                    <DataTable
                        data={displayData}
                        columns={archivedSLAColumns(handleRestore, (id) => setSlaToDelete(id))}
                        showExport={false}
                        showViewOptions={false}
                        showFilterbar={true}
                        onCreate={undefined}
