...
export const A4CardContainer = ({ children, className = '' }: { children: React.ReactNode, className?: string }) => {
    return (
        <div className={`a4-card-container py-8 px-4 bg-tremor-background-muted min-h-screen flex flex-col items-center gap-8 ${className}`}>
            {children}
        </div>
    );
};
