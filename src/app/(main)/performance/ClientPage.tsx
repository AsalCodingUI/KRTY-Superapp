...
const OverviewTab = dynamic(() => import("./components/overview/OverviewTab").then(mod => mod.OverviewTab), {
...
const KPITab = dynamic(() => import("./components/kpi/KPITab").then(mod => mod.KPITab), {
    loading: () => <div className="flex items-center justify-center py-12"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div></div>
})

const Review360Tab = dynamic(() => import("./components/360-review/Review360Tab").then(mod => mod.Review360Tab), {
    loading: () => <div className="flex items-center justify-center py-12"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div></div>
})

const OneOnOneMeetingTab = dynamic(() => import("./components/meeting/OneOnOneMeetingTab").then(mod => mod.OneOnOneMeetingTab), {
    loading: () => <div className="flex items-center justify-center py-12"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div></div>
})

const ListProjectTab = dynamic(() => import("./components/admin/ListProjectTab").then(mod => mod.ListProjectTab), {
    loading: () => <div className="flex items-center justify-center py-12"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div></div>
})

const WorkQualityTab = dynamic(() => import("./components/admin/WorkQualityTab").then(mod => mod.WorkQualityTab), {
    loading: () => <div className="flex items-center justify-center py-12"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div></div>
})
