...
import { createCompetency, updateCompetency } from "../../actions/competency-actions"
...
export function CompetencyForm({ open, onClose, onSuccess, competency }: CompetencyFormProps) {
