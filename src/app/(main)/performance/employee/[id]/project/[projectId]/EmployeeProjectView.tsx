...
export function EmployeeProjectView({ employee, assignment }: EmployeeProjectViewProps) {
            ...
            {activeTab === "sla" ? (
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-10">
                        ...
                        <Card className="lg:col-span-7 border-0 p-0">
                            <h3 className="mb-6 text-lg font-semibold text-content dark:text-content">
                                SLA Calculation
                            </h3>
                            ...
                            <Table>
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <TableHeaderCell className="text-center">Weight (%)</TableHeaderCell>
                                        <TableHeaderCell className="text-center">Result</TableHeaderCell>
                                        <TableHeaderCell className="text-center">Real Achieve</TableHeaderCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {milestones.map((milestone, index) => (
                                        <TableRow key={index}>
                                            ...
                                            <TableCell className="text-center">{milestone.weight}%</TableCell>
                                            <TableCell className="text-center">
                                                <Badge variant={
                                                    milestone.result === "Faster" ? "success" :
                                                        milestone.result === "On Time" ? "info" : "warning"
                                                }>
                                                    {milestone.result}
                                                </Badge>
                                            </TableCell>
                                            <TableCell className="text-center">{milestone.realAchieve.toFixed(1)}</TableCell>
                                        </TableRow>
                                    ))}
                                    <TableRow>
                        ...
                        {/* PARAMETER MATRIX - 30% */}
                        <Card className="lg:col-span-3 border-0 p-0">
                            <h3 className="mb-6 text-lg font-semibold text-content dark:text-content">
                                Parameter
                            </h3>
                            <Table>
