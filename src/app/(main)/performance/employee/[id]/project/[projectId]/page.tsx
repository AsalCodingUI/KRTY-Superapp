    ...
    if (isEmployee) {
        return (
            <EmployeeProjectView
                ...
                assignment={assignment as unknown as Parameters<typeof EmployeeProjectView>[0]['assignment']}
            />
        )
    } else {
        return (
            <ProjectScoringClient
                employee={result.data.employee}
                assignment={assignment as unknown as Parameters<typeof ProjectScoringClient>[0]['assignment']}
            />
        )
    }
}
