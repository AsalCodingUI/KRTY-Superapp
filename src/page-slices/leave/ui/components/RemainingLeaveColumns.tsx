...
export const remainingLeaveColumns = [
    ...
    columnHelper.display({
        id: "total_quota",
        header: ({ column }) => (
            <DataTableColumnHeader column={column} title="Total Quota" className="whitespace-nowrap" />
        ),
        cell: () => (
            <span className="tabular-nums text-content-subtle dark:text-content-placeholder">
                12 Days
            </span>
        ),
    ...
    columnHelper.accessor("leave_used", {
        header: ({ column }) => (
            <DataTableColumnHeader column={column} title="Used" className="whitespace-nowrap" />
        ),
        cell: ({ row }) => (
            <span className="tabular-nums text-content-subtle dark:text-content-placeholder">
    ...
    columnHelper.accessor("leave_balance", {
        header: ({ column }) => (
            <DataTableColumnHeader column={column} title="Remaining" className="whitespace-nowrap" />
        ),
        cell: ({ row }) => (
            <span className="tabular-nums text-content dark:text-content font-medium">
