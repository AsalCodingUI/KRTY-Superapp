                    ...
                    variants: [
                        {
                            ...
                            preview: React.createElement('button', { className: 'btn-primary' }, 'Primary Button')
                        },
                        {
                            name: 'Secondary',
                            description: 'Secondary button style for less prominent actions',
                            props: { variant: 'secondary', children: 'Secondary Button' },
                            preview: React.createElement('button', { className: 'btn-secondary' }, 'Secondary Button')
                        },
                        {
                            name: 'Destructive',
                            description: 'Destructive action button (delete, remove)',
                            props: { variant: 'destructive', children: 'Delete' },
                            preview: React.createElement('button', { className: 'btn-destructive' }, 'Delete')
                        }
                    ],
                    props: [
                        { name: 'variant', type: '"primary" | "secondary" | "destructive" | "ghost"', required: false, default: 'primary', description: 'Visual style variant' },
                    ...
                    variants: [
                        {
                            ...
                            props: { checked: false },
                            preview: React.createElement('div', { className: 'toggle' }, 'Toggle')
                        }
                    ],
                    props: [
                        { name: 'checked', type: 'boolean', required: false, default: false, description: 'Whether toggle is checked' },
                        { name: 'onChange', type: '(checked: boolean) => void', required: false, description: 'Callback when toggle changes' },
                        { name: 'disabled', type: 'boolean', required: false, default: false, description: 'Whether toggle is disabled' }
                    ],
                    examples: [
                        {
                            title: 'Basic Toggle',
                    ...
                    variants: [
                        {
                            ...
                            props: { checked: false },
                            preview: React.createElement('div', { className: 'switch' }, 'Switch')
                        }
                    ],
                    props: [
                        { name: 'checked', type: 'boolean', required: false, default: false, description: 'Whether switch is checked' },
                        { name: 'onCheckedChange', type: '(checked: boolean) => void', required: false, description: 'Callback when switch changes' },
                        { name: 'disabled', type: 'boolean', required: false, default: false, description: 'Whether switch is disabled' }
                    ],
                    examples: [
                        {
                            title: 'Basic Switch',
            ...
            components: [
                    ...
                    variants: [
                        {
                            ...
                            preview: React.createElement('input', { type: 'text', placeholder: 'Enter text...' })
                        }
                    ],
                    props: [
                        ...
                        { name: 'error', type: 'boolean', required: false, default: false, description: 'Whether input has error' }
                    ],
                    examples: [
                        {
                            title: 'Basic Input',
                    ...
                    variants: [
                        {
                            ...
                            props: { placeholder: 'Enter text...' },
                            preview: React.createElement('textarea', { placeholder: 'Enter text...' })
                        }
                    ],
                    props: [
                    ...
                    variants: [
                        {
                            ...
                            preview: React.createElement('select', {}, React.createElement('option', {}, 'Select...'))
                        }
                    ],
                    props: [
                        ...
                        { name: 'placeholder', type: 'string', required: false, description: 'Placeholder text' },
                        { name: 'disabled', type: 'boolean', required: false, default: false, description: 'Whether select is disabled' }
                    ],
                    examples: [
                        {
                            title: 'Basic Select',
                ...
                },
                {
                    ...
                    props: [
                        ...
                        { name: 'disabled', type: 'boolean', required: false, default: false, description: 'Whether checkbox is disabled' }
                    ],
                    examples: [
                        {
                ...
                },
                {
                    ...
                    props: [
                        { name: 'value', type: '{ from: Date, to: Date }', required: false, description: 'Selected date range' },
                        { name: 'onChange', type: '(range: { from: Date, to: Date }) => void', required: false, description: 'Change handler' }
                    ],
                    examples: [
                        {
        ...
        },
        {
            ...
            components: [
                    ...
                    variants: [
                        {
                            ...
                            props: {},
                            preview: React.createElement('table', {}, React.createElement('tbody', {}, React.createElement('tr', {}, React.createElement('td', {}, 'Data'))))
                        }
                    ],
                    props: [
                        { name: 'children', type: 'React.ReactNode', required: true, description: 'Table content' }
                    ],
                    examples: [
                        {
                            title: 'Basic Table',
                    ...
                    variants: [
                        {
                            ...
                            preview: React.createElement('span', { className: 'badge' }, 'Badge')
                        },
                        {
                            name: 'Success',
                            description: 'Success status badge',
                            props: { variant: 'success', children: 'Success' },
                            preview: React.createElement('span', { className: 'badge-success' }, 'Success')
                        }
                    ],
                    props: [
                        { name: 'variant', type: '"default" | "success" | "warning" | "danger"', required: false, default: 'default', description: 'Badge variant' },
                    ...
                    variants: [
                        {
                            ...
                            preview: React.createElement('div', { className: 'card' }, 'Card Content')
                        }
                    ],
                    props: [
                    ...
                    variants: [
                        {
                            ...
                            preview: React.createElement('div', { className: 'category-bar' }, 'Category Bar')
                        }
                    ],
                    props: [
                        { name: 'values', type: 'number[]', required: true, description: 'Category values' },
                        { name: 'colors', type: 'string[]', required: false, description: 'Category colors' }
                    ],
                    examples: [
                        {
                ...
                },
                {
                    ...
                    props: [
                        { name: 'data', type: 'Array<{ name: string, value: number }>', required: true, description: 'Bar data' }
                    ],
                    examples: [
                        {
                            title: 'Basic BarList',
                ...
                },
                {
                    ...
                    props: [
                        { name: 'data', type: 'Array<{ color: string, tooltip: string }>', required: true, description: 'Tracker data' }
                    ],
                    examples: [
                        {
                            title: 'Basic Tracker',
                    ...
                    variants: [
                        {
                            ...
                            props: { value: 50 },
                            preview: React.createElement('div', { className: 'progress-bar' }, 'Progress')
                        }
                    ],
                    props: [
                ...
                },
                {
                    ...
                    props: [
                        { name: 'value', type: 'number', required: true, description: 'Progress value (0-100)' },
                        { name: 'color', type: 'string', required: false, description: 'Progress color' }
                    ],
                    examples: [
                        {
                    ...
                    variants: [
                        {
                            ...
                            props: { name: 'John Doe' },
                            preview: React.createElement('div', { className: 'avatar' }, 'JD')
                        }
                    ],
                    props: [
            ...
            components: [
                {
                    ...
                    props: [
                        { name: 'open', type: 'boolean', required: true, description: 'Whether dialog is open' },
                        { name: 'onOpenChange', type: '(open: boolean) => void', required: false, description: 'Open state change handler' },
                        { name: 'children', type: 'React.ReactNode', required: true, description: 'Dialog content' }
                    ],
                    examples: [
                        {
                            title: 'Basic Dialog',
                    ...
                    variants: [
                        {
                            ...
                            preview: React.createElement('div', { className: 'callout-info' }, 'Info')
                        },
                        {
                            name: 'Warning',
                            description: 'Warning callout',
                            props: { variant: 'warning', children: 'Warning message' },
                            preview: React.createElement('div', { className: 'callout-warning' }, 'Warning')
                        }
                    ],
                    props: [
                        { name: 'variant', type: '"info" | "success" | "warning" | "danger"', required: false, default: 'info', description: 'Callout variant' },
                        { name: 'children', type: 'React.ReactNode', required: true, description: 'Callout content' }
                    ],
                    examples: [
                        {
                            title: 'Basic Callout',
                ...
                },
                {
                    ...
                    props: [
                        { name: 'message', type: 'string', required: true, description: 'Empty state message' },
                        { name: 'icon', type: 'React.ReactNode', required: false, description: 'Empty state icon' }
                    ],
                    examples: [
                        {
                    ...
                    variants: [
                        {
                            ...
                            props: {},
                            preview: React.createElement('div', { className: 'spinner' }, '⟳')
                        }
                    ],
                    props: [
                    ...
                    variants: [
                        {
                            ...
                            props: {},
                            preview: React.createElement('div', { className: 'skeleton' }, '▭')
                        }
                    ],
                    props: [
        ...
        },
        {
            ...
            components: [
                ...
                },
                {
                    ...
                    props: [
                        { name: 'type', type: '"single" | "multiple"', required: true, description: 'Accordion type' },
                        { name: 'collapsible', type: 'boolean', required: false, description: 'Whether items can collapse' }
                    ],
                    examples: [
                        {
                ...
                },
                {
                    ...
                    props: [
                        { name: 'children', type: 'React.ReactNode', required: true, description: 'Menu content' }
                    ],
                    examples: [
                        {
                ...
                },
                {
                    ...
                    props: [
                        { name: 'tabs', type: 'Array<{ label: string, value: string }>', required: true, description: 'Tab items' },
                        { name: 'activeTab', type: 'string', required: false, description: 'Active tab value' }
                    ],
                    examples: [
                        {
                ...
                },
                {
                    ...
                    props: [
                        { name: 'open', type: 'boolean', required: false, description: 'Whether command bar is open' }
                    ],
                    examples: [
                        {
            ...
            components: [
                {
                    ...
                    variants: [
                        ...
                        },
                        {
                            ...
                            preview: React.createElement('div', { className: 'divider-vertical' }, '|')
                        }
                    ],
                    props: [
                ...
                },
                {
                    ...
                    props: [
                        { name: 'mode', type: '"single" | "multiple" | "range"', required: false, description: 'Selection mode' },
                        { name: 'selected', type: 'Date | Date[]', required: false, description: 'Selected date(s)' },
                        { name: 'onSelect', type: '(date: Date | Date[]) => void', required: false, description: 'Selection handler' }
                    ],
                    examples: [
                        {
            ...
            components: [
                {
                    ...
                    props: [
                        { name: 'data', type: 'Array<Record<string, any>>', required: true, description: 'Chart data' },
                        { name: 'index', type: 'string', required: true, description: 'X-axis data key' },
                        { name: 'categories', type: 'string[]', required: true, description: 'Y-axis data keys' }
                    ],
                    examples: [
                        {
                ...
                },
                {
                    ...
                    props: [
                        { name: 'data', type: 'Array<{ name: string, value: number }>', required: true, description: 'Chart data' },
                        { name: 'category', type: 'string', required: true, description: 'Value key' }
                    ],
                    examples: [
                        {
                ...
                },
                {
                    ...
                    props: [
                        { name: 'data', type: 'Array<Record<string, any>>', required: true, description: 'Chart data' },
                        { name: 'categories', type: 'string[]', required: true, description: 'Data keys' }
                    ],
                    examples: [
                        {
