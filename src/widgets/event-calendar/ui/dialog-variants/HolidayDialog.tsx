        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[500px]">
                ...
                <div className="space-y-6 mt-4">
                    ...
                    {/* Date */}
                    <div className="p-4 bg-muted/50 rounded-lg border border-border-border">
                        <div className="flex items-center gap-3">
                            <RiCalendarLine className="w-5 h-5 text-content-muted" />
                            <div>
                ...
                {/* Actions */}
                <div className="flex justify-end pt-4 border-t border-border-border mt-4">
                    <Button
                        type="button"
                        variant="secondary"
