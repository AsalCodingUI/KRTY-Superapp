    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        ...
        <DialogBody className="space-y-6">
          ...
          {/* Date */}
          <div className="bg-muted/50 border-border-border rounded-lg border p-4">
            <div className="flex items-center gap-3">
              <RiCalendarLine className="text-content-muted h-5 w-5" />
              <div>
                <p className="text-label-md text-content">
                  {format(event.start, "EEEE, dd MMMM yyyy")}
                </p>
                {event.allDay && (
                  <p className="text-body-xs text-content-muted mt-0.5">
                    All day
                  </p>
                )}
              </div>
          ...
          <div className="bg-info-subtle border-info rounded-lg border p-3">
            <p className="text-body-xs text-info-text">
