...
export const GoogleCalendarContext = createContext<GoogleCalendarContextValue | undefined>(undefined);
    ...
    useEffect(() => {
        ...
        if (connected === 'true') {
            ...
            const errorMessages: Record<string, string> = {
                ...
                'invalid_state': 'Authorization failed: Invalid state (CSRF check failed)',
