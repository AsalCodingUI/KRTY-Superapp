...
import type { EventCategory, EventColor, EventVisibilityContextValue } from '../types';

const EventVisibilityContext = createContext<EventVisibilityContextValue | undefined>(undefined);
...
export function useEventVisibility() {
    ...
    if (!context) {
        throw new Error('useEventVisibility must be used within EventVisibilityProvider');
    }
    return context;
}
