...
const CalendarDndContext = createContext<CalendarDndContextValue | undefined>(undefined);
...
export function CalendarDndProvider({
    ...
    const handleDragEnd = (event: DragEndEvent) => {
        ...
        if (dropData.startsWith('slot-')) {
            ...
            // Calculate duration
            const duration = activeEvent.originalEnd.getTime() - activeEvent.originalStart.getTime();
    ...
    return (
        <CalendarDndContext.Provider value={value}>
            ...
            >
                ...
                <DragOverlay>
                    {activeEvent && (
                        <div className="bg-surface rounded-lg p-2 shadow-md-border opacity-90">
                            <div className="text-sm font-medium text-tremor-content-strong">
