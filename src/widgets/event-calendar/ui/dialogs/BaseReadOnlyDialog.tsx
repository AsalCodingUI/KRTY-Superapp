                ...
                <div className="space-y-6 py-4">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center gap-2 text-sm font-medium text-content">
                            <RiCalendarLine className="h-4 w-4 text-content-subtle" />
                            <span>Waktu</span>
                        </div>
                            ...
                            {event.allDay ? (
                                ...
                                <>
                                    <div className="flex items-center gap-2 text-content">
                                        <span className="text-sm text-content-subtle">Mulai:</span>
                                        <span className="text-base">
                                            {format(event.start, 'EEEE, d MMMM yyyy • HH:mm')}
                                        </span>
                                    </div>
                                    <div className="flex items-center gap-2 text-content">
                                        <span className="text-sm text-content-subtle">Selesai:</span>
                                        <span className="text-base">
                    ...
                    {showLocation && event.location && (
                        <div className="space-y-2">
                            <div className="flex items-center gap-2 text-sm font-medium text-content">
                                <RiMapPinLine className="h-4 w-4 text-content-subtle" />
                                <span>Lokasi</span>
                            </div>
                    ...
                    {event.description && (
                        <div className="space-y-2">
                            <div className="flex items-center gap-2 text-sm font-medium text-content">
                                <RiFileTextLine className="h-4 w-4 text-content-subtle" />
                                <span>Deskripsi</span>
                            </div>
                            <div className={cx(
                                "pl-6 text-base text-content",
                                "p-3 rounded-md bg-muted/30 border border-border"
                            )}>
                                {event.description}
                            </div>
                        </div>
