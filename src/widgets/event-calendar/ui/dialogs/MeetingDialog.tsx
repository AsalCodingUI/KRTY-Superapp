                ...
                <div className="space-y-6 mt-4 overflow-y-auto pr-2 flex-1">
                    ...
                    <div>
                        <div className="flex items-start justify-between gap-4">
                            ...
                            <div className="badge-primary-subtle whitespace-nowrap flex-shrink-0">
                                {event.type || 'Meeting'}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 p-4 bg-muted/50 rounded-lg border border-border">
                        <div>
                            <h4 className="text-xs font-medium text-content-subtle mb-2">Mulai</h4>
                        ...
                        <div>
                            <h4 className="text-xs font-medium text-content-subtle mb-2">Selesai</h4>
                            <p className="text-sm font-semibold text-content">
                    ...
                    {event.location && (
                        <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-lg">
                            <RiMapPinLine className="w-5 h-5 text-content-subtle flex-shrink-0 mt-0.5" />
                            <div>
                                <h4 className="text-sm font-semibold text-content mb-1">Lokasi</h4>
                                <p className="text-sm text-content-subtle break-words">{event.location}</p>
                            </div>
                        </div>
                    )}
                    ...
                    {/* Calendar Info */}
                    <div className="flex items-center gap-2 text-xs text-content-subtle border-t border-border pt-4">
