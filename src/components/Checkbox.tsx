  ...
  return (
    <CheckboxPrimitives.Root
      ...
      className={cx(
        ...
        // disabled
        "data-[disabled]:bg-muted data-[disabled]:text-content-placeholder data-[disabled]:ring-border data-[disabled]:cursor-not-allowed",
        "data-[disabled]:dark:bg-hover data-[disabled]:dark:text-content-subtle data-[disabled]:dark:ring-border-subtle",
        // checked and enabled
        "enabled:data-[state=checked]:bg-primary enabled:data-[state=checked]:ring-0 enabled:data-[state=checked]:ring-transparent",
        "enabled:dark:data-[state=checked]:bg-primary",
