  ...
  return (
    <div
      ...
      className={cx(
        ...
        {
          "!w-fit border-none bg-transparent px-0 text-content-placeholder shadow-none":
            isDecorator,
          hidden: isSpace,
          "border bg-muted text-content-placeholder dark:border-border-subtle dark:bg-hover dark:text-content-subtle":
            state.isDisabled,
          "!bg-transparent !text-content-placeholder": !segment.isEditable,
        },
      )}
    >
      <span
        aria-hidden="true"
        className={cx(
          "pointer-events-none block w-full text-left text-content-subtle sm:text-sm",
          {
...
const triggerStyles = tv({
  base: [
    // base
    "peer flex w-full cursor-pointer appearance-none items-center gap-x-2 truncate rounded-md border px-2.5 py-1.5 outline-none transition-all text-sm",
    // background color
    "bg-surface dark:bg-surface",
    // border color
    "border-border",
    ...
    return (
      <PopoverPrimitives.Trigger asChild>
        <button
          ...
          {...props}
        >
          <RiCalendar2Fill className="size-5 shrink-0 text-content-placeholder dark:text-content-subtle" />
          <span className="flex-1 overflow-hidden text-ellipsis whitespace-nowrap text-left text-content dark:text-content">
            {children ? (
              children
            ) : placeholder ? (
          ...
          <li key={index} className="sm:w-full sm:py-px">
            <button
              ...
              className={cx(
                ...
                {
                  "bg-muted dark:bg-surface": matchesCurrent(preset),
                },
              )}
        ...
        <div className="flex">
          <div className="flex flex-col sm:flex-row sm:items-start">
            {presets && presets.length > 0 && (
              <div
                className={cx(
                  ...
                  "border-b border sm:border-b-0 sm:border-r dark:border",
                  "overflow-auto",
                )}
              >
            ...
            <div>
              ...
              />
              {showTimePicker && (
                <div className="border-t border p-3 dark:border">
                  <TimeInput
                    aria-label="Time"
              ...
              <div className="flex items-center gap-x-2 border-t border p-3 dark:border">
                <Button
                  variant="secondary"
        ...
        <div className="flex">
          <div className="flex flex-col overflow-x-auto sm:flex-row sm:items-start">
            ...
            <div className="overflow-x-auto">
              ...
              />
              {showTimePicker && (
                <div className="flex items-center justify-evenly gap-x-3 border-t border p-3 dark:border">
                  ...
                  <RiSubtractFill className="size-4 shrink-0 text-content-placeholder" />
                  <div className="flex flex-1 items-center gap-x-2">
                    <span className="text-content-subtle dark:text-content-subtle">
              ...
              <div className="border-t border p-3 sm:flex sm:items-center sm:justify-between dark:border">
                <p className="tabular-nums text-content dark:text-content">
                  <span className="text-content-subtle dark:text-content-subtle">
