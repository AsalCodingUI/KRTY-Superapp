  ...
  return (
    ...
    >
      ...
      <DrawerPrimitives.Close asChild>
        <Button
          variant="ghost"
          className="aspect-square p-1 hover:bg-muted dark:hover:bg-muted"
        >
...
const DrawerFooter = ({
  ...
  return (
    <div
      className={cx(
        "flex flex-col-reverse border-t border pt-4 sm:flex-row sm:justify-end sm:space-x-2 dark:border-border",
        className,
      )}
      {...props}
    />
