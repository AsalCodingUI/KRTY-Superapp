...
-- Internal app: allow any authenticated user to manage slots
CREATE POLICY "Authenticated users can manage one-on-one slots"
ON one_on_one_slots FOR ALL
USING ( auth.role() = 'authenticated' )
...
CREATE POLICY "Authenticated users can manage review cycles"
...
CREATE POLICY "Authenticated users can manage performance summaries"
